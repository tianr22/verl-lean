...
class SFTDataset_VALUE(Dataset):
    """
    ...
    def __init__(self, parquet_files: Union[str, List[str]], tokenizer, config):
        ...
        self._download()
        self._read_files_and_tokenize_json()

    def _download(self):
        for i, parquet_file in enumerate(self.parquet_files):
            self.parquet_files[i] = copy_to_local(parquet_file, verbose=True)

    # use this for value model
    def _read_files_and_tokenize_json(self):
        self.prompts = []
        self.responses = []
        for parquet_file in self.parquet_files:
            ...
            with open(parquet_file, "r") as f:
                ...
                for line in data_set:
                    ...
                    self.prompts.append(data['input'])
                    self.responses.append(data['score'])
