...
from verl.utils.dataset import SFTDataset,SFTDataset_LEAN
...
@hydra.main(config_path="config", config_name="sft_lean", version_base=None)
def main(config):
